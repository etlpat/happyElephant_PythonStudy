...
#                                       如文件不存在则捕获异常，输出提示信息，最后关闭文件对象
#       函数：append_to_file(file_name, data)，接收文件路径以及传入数据，将数据追加写入文件中


# # 自定义包结果在该项目下的my_utils中
#
# from my_utils import file_util, str_util
# s1 = str_util.str_reverse('1234567')
# print(s1)  # 7654321
# s2 = str_util.substr('1234567', 3, 6)
# print(s2 + '\n')  # 456
#
# file_util.print_file_info('D:\Python\python项目\python_learn\测试文档\文本.txt')
# file_util.append_to_file('D:\Python\python项目\python_learn\测试文档\文本.txt','asdfghj')
# file_util.print_file_info('D:\Python\python项目\python_learn\测试文档\文本.txt')
