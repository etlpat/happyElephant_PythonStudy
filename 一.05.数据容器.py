...
#  7  | 列表.pop(下标)           | 删除指定下标的元素，并且返回删除的元素
...
#
# reverse 英文  v.逆转、反转  n.相反、逆向
# 注意：reverse默认值为False(默认从小到大排序)，如果像要反转，可以改为True
